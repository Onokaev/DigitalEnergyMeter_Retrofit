...
// MQTT details
const char* broker =  "test.mosquitto.org";// "tailor.cloudmqtt.com";
...
const char* balanceUpdateTopic = "kplc/balance_update";
const char* meterNumber = "14299";
const char* units_balance_topic = "";
