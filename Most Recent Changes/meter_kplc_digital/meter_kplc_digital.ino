...
double pulseUnit = 0.000625;  //each pulse is equivalent to this number for 1600pulses per kilowatt hour
...
void Task2Code(void *parameters)
{
  ...
  setup_GSM();
  // MQTT Broker setup
  mqtt.setServer(broker, 1883); //12702
